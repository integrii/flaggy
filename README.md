...
Sensible command-line flag parsing with excellent support for subcommands and positional values. Flags can be at any position.  Flaggy has no required project or package layout like [Cobra requires](https://github.com/spf13/cobra/issues/641), and **no third party package dependencies**!
